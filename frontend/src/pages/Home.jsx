  ...
  return (
    <div ref={ref} className="flex items-center gap-3 px-2">
      ...
      <div className="text-left">
        <p className="text-2xl font-extrabold text-brand-900 leading-none" style={{ fontFamily: 'Outfit' }}>
...
export default function Home() {
  ...
  return (
    <div className="overflow-x-hidden bg-white">
      ...
      {/* ======== HERO ======== */}
      <section className="hero-gradient relative overflow-hidden pt-20 pb-24 md:pt-24 md:pb-32">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 border border-white/15 text-blue-100 text-xs font-semibold mb-6 backdrop-blur-md">
            <Zap size={13} className="text-accent-400" />
            <span>Hecho para estudiantes y recién egresados sin experiencia</span>
          </div>

          <h1 className="text-3xl sm:text-4xl md:text-[2.75rem] font-extrabold text-white leading-[1.15] mb-4 tracking-tight" style={{ fontFamily: 'Outfit' }}>
            Tu primera oportunidad profesional{' '}
            <span className="text-accent-400">comienza aquí</span>
          </h1>

          <p className="text-base text-blue-100/80 mb-9 leading-relaxed max-w-xl mx-auto">
          ...
          <form onSubmit={handleSearch} className="max-w-2xl mx-auto">
            <div className="flex flex-col sm:flex-row bg-white rounded-2xl shadow-2xl shadow-brand-950/30 p-2 gap-2">
              <div className="flex-1 flex items-center gap-2.5 px-3 py-2 sm:border-r border-slate-100">
                <Search className="w-4 h-4 text-slate-400 flex-shrink-0" />
                <input
                  type="text"
                  placeholder="Cargo, carrera o palabra clave"
                  value={keyword}
                  onChange={(e) => setKeyword(e.target.value)}
                  className="w-full text-slate-800 placeholder-slate-400 text-sm border-0 focus:ring-0 outline-none bg-transparent"
                />
              </div>
              <div className="flex items-center gap-2.5 px-3 py-2 sm:w-48">
              ...
              <button
                type="submit"
                className="px-6 py-3 text-sm font-bold rounded-xl btn-accent flex items-center justify-center gap-2 flex-shrink-0"
              >
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 -mt-12">
        <div className="bg-white rounded-2xl shadow-xl shadow-slate-900/10 border border-slate-100 py-6 px-6 sm:px-10 grid grid-cols-2 sm:grid-cols-4 gap-y-6 gap-x-4">
      ...
      <section className="pt-16 pb-16 sm:pt-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-8">
            <div>
              <span className="text-xs font-bold text-accent-600 uppercase tracking-wider">Explora</span>
              <h2 className="text-2xl sm:text-3xl font-bold text-brand-900 mt-1" style={{ fontFamily: 'Outfit' }}>
                Busca por categoría
              </h2>
            </div>
            <Link to="/empleos" className="hidden sm:inline-flex items-center gap-1 text-sm font-semibold text-brand-700 hover:text-brand-900 transition-colors">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {categories.map((cat) => (
              <button
                ...
                className="flex flex-col items-start gap-3 p-5 rounded-2xl border border-slate-200 hover:border-brand-300 hover:shadow-md bg-white transition-all duration-200 text-left group cursor-pointer"
              >
                <div className="w-10 h-10 rounded-xl bg-brand-50 group-hover:bg-brand-700 flex items-center justify-center transition-colors">
                  <cat.icon size={19} className="text-brand-700 group-hover:text-white transition-colors" />
                </div>
      ...
      {(jobsLoading || featuredJobs.length > 0) && (
        <section className="pb-20 bg-slate-50 pt-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-end justify-between mb-8">
              <div>
                <span className="text-xs font-bold text-accent-600 uppercase tracking-wider">Oportunidades</span>
                <h2 className="text-2xl sm:text-3xl font-bold text-brand-900 mt-1" style={{ fontFamily: 'Outfit' }}>
                  Vacantes destacadas
                </h2>
              </div>
            ...
            <div className="text-center mt-10 sm:hidden">
              <Link to="/empleos" className="inline-flex items-center gap-1 text-sm font-semibold text-brand-700">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-xs font-bold text-accent-600 uppercase tracking-wider">Proceso simple</span>
            <h2 className="text-3xl sm:text-4xl font-bold text-brand-900 mt-2 mb-4" style={{ fontFamily: 'Outfit' }}>
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-6">
            ...
            {steps.map((step, idx) => (
              <div key={idx} className="relative flex flex-col items-center text-center">
                <div className="w-14 h-14 rounded-2xl bg-brand-800 flex items-center justify-center shadow-md shadow-brand-900/10 mb-5 relative z-10">
                  <step.icon size={22} className="text-white" />
                  <span className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-accent-500 text-brand-900 text-[11px] font-bold flex items-center justify-center border-2 border-white">
                    {idx + 1}
                  </span>
                </div>
                <h3 className="text-base font-bold text-brand-900 mb-2">{step.title}</h3>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="text-3xl sm:text-4xl font-bold text-brand-900" style={{ fontFamily: 'Outfit' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-brand-50 text-brand-700 text-xs font-semibold mb-5">
                <GraduationCap size={14} /> Para estudiantes
              </div>
              <h3 className="text-2xl font-bold text-brand-900 mb-7" style={{ fontFamily: 'Outfit' }}>
                ...
                {benefitsStudent.map((b, i) => (
                  <div key={i} className="flex gap-4 items-start">
                    <div className="w-10 h-10 rounded-xl bg-brand-50 flex items-center justify-center flex-shrink-0">
                      <b.icon size={20} className="text-brand-700" />
                    </div>
                    <div>
                      <h4 className="font-semibold text-slate-900 mb-0.5">{b.title}</h4>
            ...
            {/* Companies */}
            <div className="bg-brand-950 rounded-3xl p-8 shadow-sm relative overflow-hidden">
              <div className="absolute -top-10 -right-10 w-40 h-40 bg-accent-500/10 rounded-full blur-3xl" />
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 text-accent-300 text-xs font-semibold mb-5 relative">
                <Building2 size={14} /> Para empresas
              </div>
              <h3 className="text-2xl font-bold text-white mb-7 relative" style={{ fontFamily: 'Outfit' }}>
                ...
                {benefitsCompany.map((b, i) => (
                  <div key={i} className="flex gap-4 items-start">
                    <div className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center flex-shrink-0">
                      <b.icon size={20} className="text-accent-300" />
                    </div>
                    <div>
                      <h4 className="font-semibold text-white mb-0.5">{b.title}</h4>
                      <p className="text-sm text-blue-100/70 leading-relaxed">{b.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <span className="text-xs font-semibold text-amber-700 uppercase tracking-wider bg-amber-50 px-3 py-1.5 rounded-full">
              Contenido de demostración
            </span>
            <h2 className="text-3xl sm:text-4xl font-bold text-brand-900 mt-4 mb-3" style={{ fontFamily: 'Outfit' }}>
              Lo que dicen nuestros usuarios
            </h2>
            <p className="text-slate-500">Testimonios ficticios creados para fines de demostración</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonials.map((t, i) => (
              <div key={i} className="bg-white rounded-2xl p-7 border border-slate-200 shadow-sm hover:shadow-lg transition-all duration-300">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 rounded-full bg-brand-800 flex items-center justify-center text-white font-bold">
                    {t.avatar}
                  </div>
                  <div>
      ...
      <section className="hero-gradient py-20 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-4 text-center relative z-10">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-5" style={{ fontFamily: 'Outfit' }}>
