...
const PORTALS = [
  {
    ...
    iconBg: 'bg-brand-800',
    ring: 'hover:border-brand-300 hover:shadow-brand-900/10',
  ...
  },
  {
    ...
    iconBg: 'bg-slate-800',
    ring: 'hover:border-slate-400 hover:shadow-slate-900/10',
      ...
      <div className="w-full max-w-4xl relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <div className="flex justify-center mb-4">
            <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-white border border-slate-200 shadow-sm text-xs font-semibold text-slate-500">
              <Sparkles className="w-3.5 h-3.5 text-accent-500" />
              Bienvenido de vuelta
            </div>
          </div>
          <h1 className="text-3xl sm:text-4xl font-black text-brand-900 tracking-tight" style={{ fontFamily: 'Outfit' }}>
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          {PORTALS.map((p) => (
            <Link
              key={p.to}
              to={p.to}
              className={`group relative bg-white rounded-3xl border border-slate-200 p-7 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 ${p.ring}`}
            >
              ...
              <h2 className="text-xl font-bold text-brand-900 mb-1" style={{ fontFamily: 'Outfit' }}>
                Soy {p.label}
              </h2>
        ...
        <div className="mt-6 flex justify-center">
          <Link
            to="/login/admin"
            className="group inline-flex items-center gap-2.5 px-5 py-3 rounded-2xl bg-brand-900/5 hover:bg-brand-950 border border-slate-200 hover:border-brand-950 transition-all duration-300"
          >
            <ShieldCheck className="w-4 h-4 text-slate-500 group-hover:text-white transition-colors" />
            <span className="text-xs font-semibold text-slate-600 group-hover:text-white transition-colors">
        ...
        <div className="mt-10 text-center">
          <p className="text-sm text-slate-500">
            ...
            <Link to="/registro" className="text-brand-700 font-bold hover:text-brand-900 hover:underline">
              Regístrate gratis
            </Link>
          </p>
        </div>
